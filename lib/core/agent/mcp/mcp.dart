/// MCP (Model Context Protocol) system — connect external tool/resource/prompt servers.
///
/// Import this file to access all MCP types:
/// ```dart
/// import 'package:nudgee/core/agent/mcp/mcp.dart';
/// ```
library;

export 'package:nudgee/core/agent/mcp/mcp_models.dart';
