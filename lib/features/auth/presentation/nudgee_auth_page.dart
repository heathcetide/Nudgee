...
class _NudgeeAuthPageState extends State<NudgeeAuthPage>
  ...
  Future<void> _submitLogin() async {
    ...
    try {
      ...
      if (success) {
        ...
        setState(() {
          _generalError = context.l10n.authLoginFailedStorage;
          _isSubmitting = false;
        });
      }
    } catch (e) {
      if (!mounted) return;
      setState(() {
        _generalError = context.l10n.authLoginException(e.toString());
        _isSubmitting = false;
      });
    }
  }
  ...
  Future<void> _submitRegister() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _generalError = context.l10n.authRegisterException(e.toString());
        _isSubmitting = false;
      });
    }
  }
